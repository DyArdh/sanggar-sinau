...
import AddJadwalKonsultasi from './AddKonsultasi';
import EditJadwalKonsultasi from './EditKonsultasi';
import DeleteJadwalKonsultasi from './DeleteKonsultasi';

export default function JadwalKonsultasi() {
  const { jadwalKonsultasi } = useStore();
  ...
  return (
    <>
      <div className="mt-10 rounded-md border-2 border-dashed border-thirdary p-5">
        ...
        <DataTable columns={Columns} data={jadwalKonsultasi} className="mt-7" />
      </div>
      <AddJadwalKonsultasi isOpen={addJadwal} setIsOpen={setAddJadwal} onSubmit={handleAddJadwalSubmit} />
      <EditJadwalKonsultasi
      ...
      <DeleteJadwalKonsultasi
        isOpen={deleteJadwalDialog}
        setIsOpen={setDeleteJadwalDialog}
        onSubmit={handleDeleteJadwalSubmit}
      />
    </>
  );
}
