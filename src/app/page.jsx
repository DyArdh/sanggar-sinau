    ...
    <>
          ...
          <div className="max-w-[680px] rounded-[30px] border border-black border-opacity-50 bg-white px-6 py-7 md:px-8 md:py-9">
            <div>
              ...
              <p className="mt-4 opacity-80 lg:text-lg">
                ...
                mengembangkan keterampilan dasar mereka dalam suasana belajar yang menyenangkan dan interaktif. Program
                ini mencakup pembelajaran dasar seperti membaca, menulis, berhitung, serta pengembangan keterampilan
                motorik dan sosial
              </p>
            </div>
            <div>
      ...
      <section className="flex w-full bg-white md:mt-20">
        <div className="container mx-auto flex flex-col items-center justify-center pt-10 md:gap-8 md:pt-0 lg:px-16">
          ...
          <div className="mt-5 flex flex-col gap-5 md:mt-2 md:flex-row md:gap-8">
            <div className="max-w-[250px]">
              ...
              <div className="mt-4 text-center">
                ...
                <p className="mt-2 text-sm text-secondary md:text-base">Mahasiswa Universitas Jember PG PAUD</p>
              </div>
            </div>
            <div className="max-w-[250px]">
              <Image src={Section5_1} alt="Kelas PAUD" />
          ...
          <Button className="mt-8 w-1/2 bg-primary font-semibold">Lihat Selengkapnya</Button>
            ...
            <div className="w-full">
              <Accordion type="single" collapsible className="flex w-full flex-col gap-5">
                <AccordionItem value="item-1" className="border-b-0">
                  ...
                  >
                    Bimbingan belajar dilaksanakan di sanggar sinau dengan pilihan lokasi terdekat dengan rumah. Tempat
                    yang disediakan aman dan nyaman.
                  </AccordionContent>
                </AccordionItem>
      ...
      <footer className="mt-8 w-full bg-primary py-8 md:mt-0 md:py-12">
        <div className="container mx-auto md:pt-6 lg:px-16">
