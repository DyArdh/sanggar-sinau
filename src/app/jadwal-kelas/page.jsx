  ...
  return (
    <>
      <section className="flex w-full flex-col bg-white">
        ...
        <div className="container mx-auto flex flex-col pb-12 pt-12 md:gap-8 md:pb-28 md:pt-14 lg:px-16">
          ...
          <div>
            {schedule === 'Tatap Muka' ? (
              <>
                <h1 className="mt-8 text-base font-bold md:mt-4 md:text-lg">Sesi Siang - 11.00 sd 12.00</h1>
